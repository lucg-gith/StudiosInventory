...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-[#4EB5E8] text-white hover:bg-[#3A94C7]",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border-2 border-border bg-transparent text-foreground hover:bg-accent hover:text-accent-foreground",
        secondary: "bg-[#0A1628] text-white hover:bg-[#0A1628]/90",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-[#4EB5E8] underline-offset-4 hover:underline",
      },
      size: {
        default: "h-11 min-h-[44px] sm:h-10 sm:min-h-0 px-4 py-2",
